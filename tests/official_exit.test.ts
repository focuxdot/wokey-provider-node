...
describe('isOfficialExitHostAllowed', () => {
  it('allows only official vendor hosts by default', () => {
    ...
    expect(isOfficialExitHostAllowed('future-service.bytedanceapi.com', defaults)).toBe(true);
    ...
    expect(isOfficialExitHostAllowed('bytedanceapi.com', defaults)).toBe(true);
    ...
    expect(isOfficialExitHostAllowed('bytedanceapi.com.evil.example', defaults)).toBe(false);
